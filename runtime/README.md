...
状态：本目录目前只声明所有权与接口边界，没有平台代码。实现见 [ROADMAP](../docs/ROADMAP.md) Phase 2。
...
设计细节见 [ARCHITECTURE §2、§5](../docs/ARCHITECTURE.md) 与 [ROBOT_ADAPTATION §6](../docs/ROBOT_ADAPTATION.md)。

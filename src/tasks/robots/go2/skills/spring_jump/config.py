...
def make_spring_jump_env_cfg(*, play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  cfg.terminations = {
    ...
    "base_collision": TerminationTermCfg(
      func=__import__(
        "src.tasks.robots.go2.skills.shared.terminations", fromlist=["base_contact"]
      ).base_contact,
...
def make_spring_jump_runner_cfg():
  cfg = make_ppo_runner_cfg(
    ...
    save_interval=100,
    symmetry_cfg={
      "data_augmentation_func": "src.tasks.robots.go2.skills.spring_jump.mdp.symmetry:spring_jump_symmetry",

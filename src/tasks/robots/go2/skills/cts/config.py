...
def make_cts_runner_cfg():
  ...
  cfg.actor.class_name = "src.tasks.robots.go2.skills.cts.rl:CtsStudentPolicy"
  cfg.critic.class_name = "src.tasks.robots.go2.skills.cts.rl:CtsStudentPolicy"
  cfg.algorithm.class_name = "src.tasks.robots.go2.skills.cts.rl:CtsPPO"
  return cfg

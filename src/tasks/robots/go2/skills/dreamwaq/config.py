...
from src.tasks.velocity import make_rough_env_cfg
...
def make_dreamwaq_runner_cfg():
  ...
  cfg.actor.class_name = "src.tasks.robots.go2.skills.dreamwaq.mdp.rl:DreamWaQActor"
  cfg.algorithm.class_name = "src.tasks.robots.go2.skills.dreamwaq.mdp.rl:DreamWaQPPO"
  return cfg

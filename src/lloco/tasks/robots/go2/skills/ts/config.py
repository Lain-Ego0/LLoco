...
def make_ts_runner_cfg():
  ...
  cfg.actor.class_name = "lloco.tasks.robots.go2.skills.ts.rl:TsTeacherPolicy"
  cfg.critic.class_name = "lloco.tasks.robots.go2.skills.ts.rl:TsTeacherPolicy"
  cfg.algorithm.class_name = "lloco.tasks.robots.go2.skills.ts.rl:TsPPO"
  return cfg

...
def make_cts_env_cfg(*, play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  cfg.events["restitution"].params.update(high=1.0, attribute_name="_cts_restitution")
  ...
  cfg.rewards["termination"] = RewardTermCfg(func=shared_rl.terminal_cost, weight=0.0)
...
def make_cts_runner_cfg():
  ...
  cfg.actor.class_name = "lloco.tasks.robots.go2.skills.cts.rl:CtsStudentPolicy"
  cfg.critic.class_name = "lloco.tasks.robots.go2.skills.cts.rl:CtsStudentPolicy"
  cfg.algorithm.class_name = "lloco.tasks.robots.go2.skills.cts.rl:CtsPPO"
  return cfg

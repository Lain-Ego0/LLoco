"""Experiment orchestration for the generic sim-to-sim control loop."""
...
def run_mjlab_bundle(
  ...
  *,
  ...
  """Resolve a bundle and run it in a fresh headless mjlab environment."""
  if num_envs <= 0:
  ...
  cfg = load_env_cfg(binding.registry_task_id, play=True)

...
def unitree_go2_custom_runner_cfg(kind: str) -> RslRlOnPolicyRunnerCfg:
  ...
  algorithm_classes = {
    "cts": "lainloco.learning.algorithms.CtsPPO",
    "amp_cts": "lainloco.learning.algorithms.AmpCtsPPO",
    "dreamwaq": "lainloco.learning.algorithms.DreamWaQPPO",
    "amp_dreamwaq": "lainloco.learning.algorithms.AmpDreamWaQPPO",
    "amp_ts": "lainloco.learning.algorithms.AmpPPO",
    ...
    "amp_ts_student": "lainloco.learning.algorithms.TeacherStudentPPO",
    "ts": "lainloco.learning.algorithms.Go2AuxiliaryPPO",
    "ts_student": "lainloco.learning.algorithms.TeacherStudentPPO",
  }
  actor_classes = {
    "cts": "lainloco.learning.models.CtsActorModel",
    "amp_cts": "lainloco.learning.models.CtsActorModel",
    "dreamwaq": "lainloco.learning.models.DreamWaQActorModel",
    "amp_dreamwaq": "lainloco.learning.models.DreamWaQActorModel",
    "amp_ts": "lainloco.learning.models.TeacherActorModel",
    "amp_ts_student": "lainloco.learning.models.StudentActorModel",
    "ts": "lainloco.learning.models.TeacherActorModel",
    "ts_student": "lainloco.learning.models.StudentActorModel",
  }
  critic_classes = {
    "cts": "lainloco.learning.models.CtsCriticModel",
    "amp_cts": "lainloco.learning.models.CtsCriticModel",
  }
  try:
  ...
  if kind in (
    ...
    cfg.actor.distribution_cfg["class_name"] = (
      "lainloco.learning.models.Go2ClampedGaussianDistribution"
    )
